...
void MeshWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            typedef void (MeshWidget::*_t)(QMouseEvent * );
        ...
        {
            typedef void (MeshWidget::*_t)(const Ray & );
        ...
        {
            typedef void (MeshWidget::*_t)(const Ray & );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&MeshWidget::_signalErosion)) {
                *result = 6;
                return;
            }
        }
...
const QMetaObject MeshWidget::staticMetaObject = {
    { &QOpenGLWidget::staticMetaObject, qt_meta_stringdata_MeshWidget.data,
...
// SIGNAL 6
void MeshWidget::_signalErosion(const Ray & _t1)
{
